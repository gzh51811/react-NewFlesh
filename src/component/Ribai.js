...
class Ribai extends Component {
    ...
    render() {
        console.log('232', this)
        return (<div>
            <p className="category-title" >日销明星</p>
                ...
                <div className="somelist " >
                    {
                        this.state.datalist.map(goods => {
                            return (<div style={{ overflow: 'hidden', }} key={goods._id} className="bigbox" onClick={this.gotoGoods.bind(this, goods._id)}>
...
Ribai = withAxios(Ribai);
export default Ribai;